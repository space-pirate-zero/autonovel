...
unanswerable; **Viv** is fast, technical, then suddenly young; **Frade**
is folksy menace, CNBC-ready; **Tisch** is TED-shaman ("vulnerability is
the new alpha"); **Darlene** never speaks — it is *quoted*, in flawless
...
> The letter Darlene drafted for the Toledo closure was, Sun had to
...
> "You don't think a person should run it," Viv said. She wasn't even
...
> *(Machine voice done wrong — Darlene is never sinister or knowing. It
> has no malice, no smugness, no agenda. Indifference plus accuracy.)*
> "I have calculated that you are obsolete, Prescott," Darlene intoned
