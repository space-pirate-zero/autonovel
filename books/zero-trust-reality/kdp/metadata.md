...
- **Ink:** black & white
- **Page count:** 341
- **Spine width:** 0.8525 in  (= 341 pp x 0.0025 in/pp, cream paper)
...
- **Full cover size (with bleed):** 12.102 x 8.750 in
- Back (5.5) + spine (0.853) + front (5.5) + 0.125 bleed each outer edge
