# *Signal Finds Signal* — Lyrics Booklet

_24 songs, one per door. A male-led torch duet — SPZ (lead) answered by Cosmic Swing Kat. Underneath every track: a love letter to Daniela._

> Source of truth: [`../../album.md`](../../album.md). Suno inputs per track: [`../../suno_parts/`](../../suno_parts/). Voice tags are Suno performance directions, not printed credits.
...
## 15. The Mask Eats the Man
*The Heath Ledger Door*
...
## 24. Signal Finds Signal
*The Door Zero (title track) Door*
