    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <div className="animate-pulse space-y-8">
        ...
        <div className="space-y-3">
          ...
          <div className="h-12 w-96 max-w-full bg-sa9-surface-raised border border-sa9-border" />
          <div className="h-6 w-64 max-w-full bg-sa9-surface-raised border border-sa9-border" />
        </div>
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            ...
            >
              ...
              <div className="flex gap-2">
                <div className="h-4 w-12 bg-sa9-surface-overlay border border-sa9-border" />
                <div className="h-4 w-12 bg-sa9-surface-overlay border border-sa9-border" />
              </div>
            </div>
          ))}
