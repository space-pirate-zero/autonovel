...
The implant scar at the base of her skull, right side, warms. Faint cyan. *Stay in the shadow,* the warmth seems to say, in a voice that has always sounded like comfort. *You're safe here. You're invisible here. Nobody can blame the system that isn't on the books.* The propaganda doesn't shout. It never shouts. It soothes.

Push the alert and she breaks the read-only promise she gave to get in the door. She exposes a shadow system nobody approved. If she's wrong about even one field, she's the unauthorized contractor who triggered a false alarm on a holiday and crashed payment routing for a Fortune 500. That email writes itself. She can see it in the CISO's drafts folder already.

Stay in the shadow and she's clean. Untouchable. And $4.2 million walks out the door past a legacy system that did exactly what it was told.
...
ZERO stops thinking. This is the boxing part — the part her trainer in Decatur drilled until it lived below thought. You don't decide to throw the punch. You've already thrown it; the deciding was the months of work that made the arm move without you.
...
The last line is a joke she makes to keep her hands from shaking. She leaves it in.
...
The elevator at the end of the dead floor opens. BISHOP walks out fast — faster than ZERO has ever seen him move, Oxfords loud on the carpet, Parker Jotter still clipped in his pocket. He's been at home. He came back. He crosses the gray floor under the half-dead lights and stops at her desk and looks at the screen, at the quarantine, at the residual number, at the timestamps.

Then he looks at her.

And here is the thing ZERO will remember when the rest of the night has gone soft at the edges. BISHOP's badge, the MegaCorp ID that has hung crooked on its navy lanyard at fifteen, twenty degrees off true for fifteen straight years — his small daily middle finger to a building that fired Keisha for being right — that badge hangs perfectly, dead-level, plumb-line straight.

He doesn't fix it. He doesn't touch it. It just is.

For one night the rules and the right thing point the same direction, and the rebellion isn't necessary, because the system did the thing the system was supposed to do, because someone with no authority and a quiet skull decided not to stay safe.
...
Every shadow-to-record run moves through four phases. Most insurgents die between Phase 1 and Phase 3 because they get comfortable in the shadow and never force the inversion.
...
The supply-chain attack walked past the legacy because the legacy was *built to trust the vendor.* This is not a bug. It's a feature working as designed, against you.
...
The implant in ZERO's skull is the literal version of a thing every insurgent carries: the soothing voice that says *stay safe, stay invisible, don't break the promise, nobody can blame the thing that isn't on the books.* That voice is not your friend. It's the conditioning of a system that benefits from your silence. Marley named the cage: *emancipate yourselves from mental slavery.* The fifteen seconds is the emancipation, performed under deadline, with your career in the wire.

You don't win the fifteen seconds with courage. You win it with the ninety-two days behind you. Push the alert because the boring already proved you right. The push is just the moment everyone else finds out.

---

## BOSS PROFILE: The Legacy Vendor

**INTEL.** The Legacy Vendor is not in the room tonight, and that's the point. It's been embedded for eleven years. It has the standing instructions, the trusted-vendor waivers, the integration nobody dares touch before a holiday. It is not evil and it is not stupid. It is *old,* and old systems carry the fossilized decisions of people who left years ago. Its core defense has always been Vendor Gravity (F_g, Ch 2): too embedded to remove, too political to question. Tonight that gravity inverted. The thing that made it un-removable — its deep, unexamined, eleven-year trust — is exactly what let $4.2M walk past it wearing a valid signature.
